...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Create Workouts
        workout1 = Workout.objects.create(name='Cardio', description='Cardio workout')
        workout2 = Workout.objects.create(name='Strength', description='Strength workout')
